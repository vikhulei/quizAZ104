...
{q: 'What needs to be installed and used to enable password hash synchronization between on-prem and Azure?', a: 'Install Azure AD Connect, use Azure portal', tag: 0},
{q: 'Are new users replicated to trusted forests and cild domains?<br>Are schema changes replicated between trusted forests and praten', a: '', tag: 0},
{q: '', a: '', tag: 0},
{q: '', a: '', tag: 0},
],
Definitions: [
